...
<html lang="en">
    ...
    <body>
        ...
        <div id="line-one">
                <div class="row">  
                    <br>
                    <h4 id="center"><b>ALTERAÇÃO DE DADOS DO EQUIPAMENTO {{$equipamento->id}}</b></h4>
                    <br> 
                    <form method="post" 
                          action="{{route('equipamento.update', $equipamento->id)}}" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="price">Tempo</label>
                                <input type="text" name="tempo"                               
                                       class="form-control"
                                       value="{{$equipamento->tempo}}"
                                       required>
                            </div>
                        </div>
